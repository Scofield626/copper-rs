...
//! the contract's objective computed from what was measured.
...
pub struct CuScoreRow {
    ...
    /// The objective's tiers from the measured p99 latencies and delivered
...
mod tests {
    ...
    #[test]
    fn ranks_measured_candidates_by_the_objective_and_keeps_predictions() {
